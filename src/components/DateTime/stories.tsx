...
storiesOf('DateTime', module)
  ...
  .add('disabled', () => <DateTime onChange={ console.log } initialValue={ new Date().toISOString() } isDisabled />)
  .add('hidden', () => <DateTime onChange={ console.log } initialValue={ new Date().toISOString() } isHidden />)
